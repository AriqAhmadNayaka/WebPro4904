...
const PostCard = ({ post }) => {
  // Membatasi isi artikel agar tampilan card tetap ringkas.
  ...
  // Mengubah tanggal menjadi teks relatif seperti Today atau Yesterday.
  ...
  return (
    <article className="rounded-lg border border-gray-200 bg-white p-6 shadow-md transition-shadow hover:shadow-lg">
      ...
      {/* Ringkasan artikel diambil dari field article pada API. */}
      ...
      <div className="flex items-center justify-between">
        ...
        <Link
          to={`/posts/${post.id}`}
          className="inline-flex items-center font-medium text-blue-600 transition-colors hover:text-blue-500"
        >
          Read more
          <svg
