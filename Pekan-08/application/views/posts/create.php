...
<div class="card">
    <h2>Menambahkan Jenis Makanan</h2>
    <hr style="margin: 20px 0; border: none; border-top: 2px solid #e0e0e0;">

    <?php echo form_open_multipart('posts/store'); ?>

        <div class="form-group">
            <label for="title">Nama Makanan <span style="color: red;">*</span></label>
            <input type="text" 
                name="title" 
                id="title" 
        ...
        <div class="form-group">
            <label for="author">Asal Makanan <span style="color: red;">*</span></label>
            <input type="text" 
                name="author" 
                id="author" 
        ...
        <div class="form-group">
            <label for="article">Deskripsi Makanan <span style="color: red;">*</span></label>
