...
<body>
    ...
    <!--
        form action diarahkan ke Auth::do_register() di CI3
        menggantikan action="" di native yang memproses di file yang sama
    -->
    <div class="form-container">
        <form class="form-box" action="<?php echo base_url('auth/do_register'); ?>" method="POST">
    ...
    <div class="login-link">
        <!-- menggantikan href="login.php" menjadi URL CI3 -->
