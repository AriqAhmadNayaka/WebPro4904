    ...
    <div class="layout">
        <aside class="sidebar">
            ...
            <ul class="menu">
                ...
                <li><a href="<?php echo base_url('layanan'); ?>">Layanan Informasi</a></li>
                <li><a href="kontak.php">Kontak</a></li>
                <li>
                    <a href="<?php echo base_url('auth/logout'); ?>"
                        style="color:#dc2626; margin-top:16px; border-top:1px solid #e5e7eb; padding-top:16px;"
        ...
        <main class="main">
            <div class="container">
                <section class="hero">
                    <h1>Halo Dokter, <?php echo $nama_dokter; ?>!</h1> // Menampilkan nama dokter menggunakan variabel $nama_dokter
                    ...
                    <section class="section-info">
                        ...
                        <div class="right">
                            <img src="<?php echo $ilustrasi; ?>" alt="Ilustrasi Dokter"> // Menampilkan gambar ilustrasi menggunakan variabel $ilustrasi
                        </div>
                    </section>
