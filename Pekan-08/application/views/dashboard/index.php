        ...
        <div class="nav-right">
            ...
            <div class="profile-dropdown">
                ...
                <div class="dropdown-menu">
                    ...
                    <hr>
                    <!-- menggantikan href="login.php" menjadi URL CI3 auth/logout -->
    ...
    <nav class="side-floating-nav" aria-label="Navigasi Utama">
        <div class="side-rail">
            ...
            <div class="side-bottom">
                ...
                <!-- menggantikan href="logout.php" menjadi URL CI3 auth/logout -->
    ...
    <div class="login-options">
        <div class="login-row">
            ...
            <div class="login-row">
                ...
                <!-- menggantikan href="dompet.php" menjadi URL CI3 -->
