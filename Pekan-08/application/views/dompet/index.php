...
<head>
  ...
  <style>
    ...
    * {
    ...
    .produk-terlaris .name { font-size: 18px; font-weight: 700; margin-top: 4px; }
    .produk-terlaris small { font-size: 12px; }
    ...
    @media (max-width: 640px) {
      ...
      .col-3, .col-4, .col-8 { flex: 0 0 100%; }
...
<body>
  <!-- menggantikan href="tampilanutama.html" menjadi URL CI3 dashboard -->
  <header class="header">
  ...
  <main class="main">
    ...
    <section id="section-laporan-manual" style="margin-top: 24px; scroll-margin-top: 80px">
      ...
      <div class="row">
        ...
        <!--
          form action diarahkan ke Dompet::simpan() di CI3
          menggantikan action="" yang memproses di file yang sama
          enctype multipart/form-data tetap dipertahankan untuk upload file
        -->
        <form id="formManual" method="POST" enctype="multipart/form-data" action="<?php echo base_url('dompet/simpan'); ?>">
          <!-- form untuk mengirim data ke server menggunakan metode POST 
        ...
        <div class="table-card" style="flex:1;">
          ...
          <?php foreach($dataLaporan as $row): ?>
            ...
            <!-- menggantikan while(mysqli_fetch_assoc($dataLaporan)) dari native -->
          <tr>
              ...
              <td>
                <?php if($row['file']){ ?>
                  <!-- menggantikan href="uploads/..." menjadi base_url CI3 -->
                  <a href="<?php echo base_url('uploads/' . $row['file']); ?>" target="_blank">Lihat</a>
                <?php } ?>
              </td>
              <td>
                <!-- menggantikan href="?edit=ID" menjadi URL CI3 dengan query string -->
                <a href="<?php echo base_url('dompet') . '?edit=' . $row['id']; ?>" 
                   class="btn-edit">Edit</a>
                <!-- mengirim id ke URL untuk mengambil data dan menampilkannya ke form agar bisa diedit -->
                <!-- menggantikan href="?hapus=ID" menjadi URL CI3 dompet/hapus/ID -->
