...
<body class="background">
    <nav class="top-navbar">
        <div class="nav-left">
            <div class="logo">
                <h3 class="logo-text">Selamat datang di NaviBiz, <?php echo htmlspecialchars($nama ?? 'Pengguna'); ?></h3>
            </div>
        </div>
        ...
        <div class="nav-right">
            ...
            <div class="profile-dropdown">
                <button class="nav-icon profile-icon" aria-label="Profil">
                    <img src="<?php echo base_url('profil.jpeg'); ?>" alt="Profil" class="avatar">
                </button>
                <div class="dropdown-menu">
                    <div class="profile-info">
                        <img src="<?php echo base_url('profil.jpeg'); ?>" alt="Aila" class="avatar-lg">
                        <div>
                            <p class="name">Aila</p>
                    ...
                    <hr>
                    <a href="<?php echo base_url('index.php/auth/logout'); ?>" class="dropdown-item logout">Logout</a>
                </div>
            </div>
        </div>
    </nav>
    ...
    <div class="slider" id="Dashboard">
        ...
        <div class="slide active">
            <div class="pamflet-card">
                <img src="<?php echo base_url('3.png'); ?>" alt="Pamflet 1">
        ...
        <div class="slide">
            <div class="pamflet-card">
                <img src="<?php echo base_url('2.png'); ?>" alt="Pamflet 2">
                <div class="pamflet-info">
        ...
        <div class="slide">
            <div class="pamflet-card">
                <img src="<?php echo base_url('1.png'); ?>" alt="Pamflet 3">
                <div class="pamflet-info">
    ...
    <div class="login-options">
        <div class="login-row">
            <a href="petaumkm.html" style="text-decoration: none;">
                <div class="login-option">
                    <video class="circle-video" autoplay loop muted playsinline>
                        <source src="<?php echo base_url('peta.mp4'); ?>" type="video/mp4">
                    </video>
            ...
            <a href="investasi.html" style="text-decoration: none;">
                <div class="login-option">
                    <video class="circle-video" autoplay loop muted playsinline>
                        <source src="<?php echo base_url('investasi saham.mp4'); ?>" type="video/mp4">
                    </video>
            ...
            <a href="kategori.html" style="text-decoration: none;">
                <div class="login-option">
                    <video class="circle-video" autoplay loop muted playsinline>
                        <source src="<?php echo base_url('umkm.mp4'); ?>" type="video/mp4">
                    </video>
            ...
            <div class="login-row">
                <a href="delivery.html" style="text-decoration: none;">
                    <div class="login-option">
                        <video class="circle-video" autoplay loop muted playsinline>
                            <source src="<?php echo base_url('delivery.mp4'); ?>" type="video/mp4">
                        </video>
                        <label>Delivery</label>
                    </div>
                </a>

                <a href="<?php echo base_url('index.php/dompet'); ?>" style="text-decoration: none;">
                    <div class="login-option">
                        <video class="circle-video" autoplay loop muted playsinline>
                            <source src="<?php echo base_url('dompet.mp4'); ?>" type="video/mp4">
                        </video>
                ...
                <a href="pesan.html" style="text-decoration: none;">
                    <div class="login-option">
                        <video class="circle-video" autoplay loop muted playsinline>
                            <source src="<?php echo base_url('pesan.mp4'); ?>" type="video/mp4">
                        </video>
                        <label>Pesan</label>
                    </div>
                </a>
        ...
        <div class="chat-section">
            <a href="konsultasiai.html" style="text-decoration: none;">
                <div class="chat-option">
                    <video class="kotak-option" autoplay loop muted playsinline>
                        <source src="<?php echo base_url('ai asisten.mp4'); ?>" type="video/mp4">
                    </video>
            ...
            <a href="komunitas.html" style="text-decoration: none;">
                <div class="chat-option">
                    <video class="kotak-option" autoplay loop muted playsinline>
                        <source src="<?php echo base_url('komunitas.mp4'); ?>" type="video/mp4">
                    </video>
