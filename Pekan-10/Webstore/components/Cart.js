export function Cart(cart, onCheckout) {
    ...
    // Jika belum ada produk, tampilkan pesan kosong dan hentikan proses render cart.
    if (cart.length === 0) {
    ...
    // Membuat elemen item keranjang untuk setiap produk yang sudah ditambahkan.
    cart.map((item) => {
...
`;
    ...
    // Menghitung total harga seluruh produk di dalam keranjang.
...
`;
    ...
    // Tombol checkout menjalankan callback dari app.js.
