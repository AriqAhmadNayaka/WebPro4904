// Komponen untuk menampilkan daftar produk dalam bentuk kartu.
export function ProductList(products, onAdd) {
    ...
    products.map((product) => {
        ...
        // Diskon dibuat acak agar tampilan badge produk lebih dinamis.
        ...
        // Saat tombol Add diklik, produk dikirim ke fungsi addToCart di app.js.
...
// Fungsi helper untuk membuat ikon bintang rating dalam bentuk SVG.
function getStarSVG() {
