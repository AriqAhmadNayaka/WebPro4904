...
<body class="auth-body">
    ...
    <main class="container auth-layout">
        <section class="hero-card">
            <p class="eyebrow">Sistem Pelaporan Parkir Liar</p>
            <h2>Masuk untuk mengelola laporan parkir liar dengan cepat.</h2>
            <p>Dashboard akan menampilkan total laporan, status pelanggaran, dan data laporan terbaru sesuai user login.</p>
        </section>
