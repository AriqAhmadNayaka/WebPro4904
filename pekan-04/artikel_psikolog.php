    ...
    <div class="main-container">
        <div class="content">
            ...
            <div class="article-card">
                <div class="header-post">
                    ...
                    <form method="POST" action="create.php">
                        <input type="text" name="isi_artikel" id="isi_artikel" placeholder="Buat sebuah artikel">
                        <hr>
                        <div class="post-actions">
                            <i class="fas fa-image post-icon"></i>
                            <button type="submit" name="submit" class="btn-posting">Posting</button>
                        </div>
                    </form>
                    </div>
                </div>
            ...
            <?php
                ...
                $query = mysqli_query($conn, $sql); //menjalankan query dan juga koneksi
          ...
          ?>
            <div class="article-card">
                <div class="article-info">
                    ...
                    <button class="btn-posting"><a href="edit.php?id_artikel=<?php echo $data['id_artikel']; ?>">Edit</a></button> <!--menampilkan tombol edit untuk mengedit artikel yang
