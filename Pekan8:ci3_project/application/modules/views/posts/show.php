...
<div class="card">
    ...
    <div style="margin-bottom: 20px;">
        <p style="color: #666; font-size: 14px;"><strong>Author:</strong> <?php echo date('F d, Y H:i', strtotime($post->created_at)); ?></p>
    <?php endif; ?>
    <?php if(isset($post->updated_at) && $post->updated_at != $post->created_at): ?>
        <p style="color: #666; font-size: 14px;"><strong>Updated:</strong> <?php echo date('F d, Y H:i', strtotime($post->updated_at)); ?></p>
    <?php endif; ?>
    </div>
