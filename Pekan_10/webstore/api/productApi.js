// Fungsi ini mensimulasikan proses mengambil data produk dari API/server.
export const fetchProducts = async () => {
  return new Promise((resolve) => {
    // setTimeout digunakan untuk memberi efek delay seperti request asynchronous.
    setTimeout(() => {
      // Data produk statis yang akan dikirim ke app.js melalui Promise.
      resolve([
        {
          id: 1,
