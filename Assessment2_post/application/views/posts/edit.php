...
<a href="<?php echo base_url('posts'); ?>" class="back-link btn btn-info"> Kembali ke laporan</a>
...
<div class="card">
    ...
    <?php echo form_open_multipart('posts/update/' . $post->id); ?>
        ...
        <div class="form-group">
            <label for="title">Lokasi Stasiun </label>
            <input type="text" 
                   name="title" 
                   id="title" 
        ...
        <div class="form-group">
            <label for="author">Kondisi Udara </label>
            <input type="text" 
                   name="author" 
                   id="author" 
