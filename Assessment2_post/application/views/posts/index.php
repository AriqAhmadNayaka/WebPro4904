...
<div class="card">
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
        <h2>All Posts</h2>
        <a href="<?php echo base_url('posts/create'); ?>" class="btn btn-success">+ Buat laporan baru</a>
    </div>

    <?php if(empty($posts)): ?>
        <div class="text-center" style="padding: 40px;">
            <p style="font-size: 18px; color: #666;">No posts found. Create your first post!</p>
            <a href="<?php echo base_url('posts/create'); ?>" class="btn btn-primary" style="margin-top: 20px;">Buat laporan</a>
        </div>
    <?php else: ?>
        <table>
            <thead>
