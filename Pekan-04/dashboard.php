...
$user_data = getCurrentUserProfile($conn, $_SESSION['email']);

if ($user_data) {
    syncUserSessionFromProfile($user_data);
}

$nama_user = !empty($_SESSION['nama_lengkap']) ? $_SESSION['nama_lengkap'] : (isset($_SESSION['username']) ? $_SESSION['username'] : 'Tamu');
$foto_profil = isset($_SESSION['foto_profil']) ? $_SESSION['foto_profil'] : getDefaultProfilePhoto();
?>
        ...
        <div class="hero-slider">
            <div class="slider-container">
                <div class="hero-item active">
                    <img src="bdg2.jpg" alt="Gedung Sate" class="hero-img">
                ...
                <div class="hero-item">
                    <img src="KOPI1.jpg" alt="Festival Angklung" class="hero-img">
                    <div class="hero-overlay"></div>
                    <div class="hero-content">
            ...
            <div class="map-sidebar">
                ...
                <div class="nearby-list">
                    <div class="nearby-card js-focus-map" data-lat="-6.9175" data-lng="107.6191" tabindex="0" role="button">
                        <img src="bdg5.jpg" alt="Gedung Sate">
                        <div class="details">
