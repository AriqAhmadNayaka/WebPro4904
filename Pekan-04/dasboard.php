...
<body>
    ...
    <div class="main-conten" style="margin: top 40px;">
            <h2>Daffar Tempat yang Ingin Dikunjungi</h2>
            <?php
            include 'koneksi.php';
            $data = mysqli_query($conn, "SELECT * FROM wishlist");//Mengambil data dari tabel whislist 
            ?>
            <table border="1" cellpadding="10" style="background:white;">
                <tr>
                    ...
                    <th>Harga Tiket</th>
                    <th>Aksi</th>
                </tr><!--Tabel untuk menampilkan data-->
                ...
                <tr>
                    <td><?=  $row['nama_tempat']; ?></td>
                     ...
                     </td><!--Menampilkan data nama tempat,lokasi,harga tiket dan mengirim ID ke edit.php sama hapus php-->
                </tr>
                <?php } ?>
            </table>
            <br>
    ...
    <div class="main-content">
        ...
        <div class="contribution-banner"
            style="background: linear-gradient(135deg, #27ae60, #2ecc71);
             border-radius: 20px; padding: 30px; margin-top: 30px; color: white;
              display: flex; align-items: center; justify-content: space-between;">
            <div>
                <h2 style="margin: 0;">Bantu Lestarikan Bandung!</h2>
                <p style="opacity: 0.9; margin-top: 5px;">
                    Punya foto jadul atau info gedung bersejarah? Bagikan di sini.
                </p>
            </div>
