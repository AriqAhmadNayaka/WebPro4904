...
<body>
    ...
    if(isset($_POST['submit'])){ //mengecek apakah form pendaftaran sudah dikirim
        ...
        $alamat = $_POST['alamat'];
        //mengambil semua data yang diinput oleh pengguna dari form

        $query = "INSERT INTO user (name, email, username, password, telepon, alamat)
          VALUES ('$name','$email','$username','$password','$telepon','$alamat')";
        //membuat perintah SQL untuk menyimpan data user ke dalam tabel database

        if(mysqli_query($conn, $query)){ //menjalankan perintah INSERT ke database
            echo "BERHASIL";
        } else {
            echo "ERROR: " . mysqli_error($conn);
        } //menampilkan jika registrasi berhasil atau error
    }
    ?>
