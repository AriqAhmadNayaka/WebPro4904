    ...
    // Variabel ini digunakan untuk menampilkan data login pengguna
     if ($usernameErr == "" && $passwordErr == "") {
        ...
        if ($result->num_rows > 0) {
            ...
            // Menyimpan data pengguna ke dalam session untuk digunakan di halaman lain setelah login berhasil
            ...
            exit();
            // Jika tidak ada data yang cocok, berarti login gagal dan menampilkan pesan alert kepada pengguna
            } else {
...
<body>
    ...
    <div style="text-align:center; margin-top:20px;"> 
        ...
        <!-- Menampilkan informasi kepada pengguna bahwa sistem akan mengarahkan mereka ke halaman dashboard -->
