...
// Proses jika form manual di-submit (Create data)
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['tambah_manual'])) {
    ...
    $stmt = $conn->prepare("INSERT INTO keuangan (tanggal, keterangan, jenis, jumlah) VALUES (?, ?, ?, ?)");
    $stmt->bind_param("sssi", $tgl, $ket, $jenis, $jumlah);
    $stmt->execute();
    ...
    <section id="section-laporan-manual" style="margin-top: 24px; scroll-margin-top: 80px">
      ...
      <div class="row">
        <div class="form-card">
          ...
          <form id="formManual" method="post" action="">
            ...
            <div class="btn-group">
              <button type="submit" name="tambah_manual" class="btn">Simpan</button>
