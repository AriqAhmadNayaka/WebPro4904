...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            // Form login memakai fungsi dari AuthContext supaya penyimpanan token terpusat.
            ...
            setError(
                err.message ||
                'Terjadi kesalahan saat login. Pastikan server CodeIgniter 3 sudah berjalan.'
            );
    ...
    return (
        <div className="min-h-screen bg-gray-100 flex flex-col">
            ...
            <div className="flex-1 flex flex-col items-center justify-center px-6 py-8">
                ...
                <a
                    href="#"
                    className="flex items-center mb-8 text-2xl font-semibold text-gray-900"
                >
                    <svg
                ...
                <div className="w-full max-w-md bg-white rounded-xl shadow-lg border border-gray-200 p-8">
                    ...
                    {error && (
                        <div
                            className="mb-6 p-4 text-sm text-red-700 bg-red-100 rounded-lg border border-red-200"
                            role="alert"
                        >
                            {error}
                        </div>
