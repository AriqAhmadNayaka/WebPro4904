//import untuk mengelola state lokal, useNavigate untuk navigasi setelah login,
//dan useAuth untuk mengakses fungsi login dari konteks autentikasi
import { useState } from 'react';
import { useNavigate } from 'react-router-dom';
import { useAuth } from '../context/AuthContext';

// Komponen Login yang menangani proses login pengguna
const Login = () => {
    ...
    const [loading, setLoading] = useState(false); // State untuk menandakan apakah proses login sedang berlangsung
    ...
    const handleSubmit = async (e) => {
        ...
        // Memanggil fungsi login dengan email dan password yang dimasukkan pengguna
        try {
        ...
        } catch (err) { // Menangani error yang mungkin terjadi selama proses login
            console.error('Login error:', err);
            setError(err.message || 'Terjadi kesalahan saat login. Pastikan server Laravel sudah berjalan.');
        } finally { // Mengatur loading menjadi false setelah proses login selesai, baik berhasil maupun gagal
            setLoading(false);
        }
    };

    // Render form login dengan styling menggunakan Tailwind CSS
    return (
            ...
            <div className="flex-1 flex flex-col items-center justify-center px-6 py-8">
                <a href="#" className="flex items-center mb-8 text-2xl font-semibold text-gray-900">
                    <svg className="w-10 h-10 mr-3 text-blue-600" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        <path d="M5 3a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2V5a2 2 0 00-2-2H5zM5 11a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2v-2a2
                         2 0 00-2-2H5zM11 5a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V5zM14 11a1 1 0 011 1v1h1a1 1 0 110 2h-1v1a1 1 
                         0 11-2 0v-1h-1a1 1 0 110-2h1v-1a1 1 0 011-1z"></path>
                    </svg>
                    Blog Posts
                </a>
...
// Export komponen Login sebagai default export agar bisa digunakan di bagian lain aplikasi
