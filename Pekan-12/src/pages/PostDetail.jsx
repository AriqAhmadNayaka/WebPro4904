//meng import React dan beberapa hook serta komponen yang diperlukan
...
// Komponen PostDetail yang menampilkan detail dari sebuah post berdasarkan ID yang diberikan
const PostDetail = () => {
    const { id } = useParams();
    ...
    // Menggunakan useEffect untuk memanggil fungsi fetchPost saat komponen pertama kali dirender atau saat ID berubah
    useEffect(() => {
        fetchPost();
    }, [id]);

    // Fungsi untuk mengambil data post dari API berdasarkan ID yang diberikan
    ...
    // Menampilkan loading spinner jika data masih dalam proses pengambilan
    if (loading) {
        return (
