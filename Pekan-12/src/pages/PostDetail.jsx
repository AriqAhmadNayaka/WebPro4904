...
const PostDetail = () => {
    ...
    const fetchPost = async () => {
        try {
            ...
            // ID diambil dari URL, lalu dipakai untuk meminta satu post tertentu.
    ...
    const formatDate = (dateString) => {
        // Tanggal dari database dibuat lebih mudah dibaca untuk tampilan Indonesia.
        if (!dateString) {
            return '';
        }
        ...
        <div className="min-h-screen bg-gray-100 flex flex-col">
            ...
            <main className="flex-1">
                ...
                <div className="py-8 px-4 mx-auto max-w-screen-lg lg:py-16 lg:px-6">
                    ...
                    {/* Detail lengkap post yang dipilih user dari dashboard/all post. */}
