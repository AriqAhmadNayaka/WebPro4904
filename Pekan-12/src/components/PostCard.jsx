...
const PostCard = ({ post }) => {
    ...
    return (
        <article className="bg-white rounded-lg border border-gray-200 shadow-md hover:shadow-lg transition-shadow overflow-hidden">
            {imageUrl && (
                <Link to={`/posts/${post.id}`} className="block bg-gray-100">
                    <img
                        src={imageUrl}
                        alt={post.title}
            ...
            <div className="flex justify-between items-center">
                ...
                <Link to={`/posts/${post.id}`} className="inline-flex items-center font-medium text-blue-600 hover:text-blue-500 transition-colors">
                    Read more
