// Footer menampilkan informasi brand, daftar resource, tautan sosial, dan copyright.
const Footer = () => {
    return (
        // Elemen footer diberi border atas agar jelas memisahkan konten utama dengan bagian bawah halaman.
        <footer className="bg-white border-t border-gray-200">
            <div className="max-w-screen-xl mx-auto px-4 py-8">
                {/* Blok utama footer mengatur brand di kiri dan kumpulan tautan di kanan pada layar menengah ke atas. */}
                <div className="md:flex md:justify-between">
                    {/* Area brand berisi ikon, nama aplikasi, dan deskripsi singkat aplikasi blog. */}
                    ...
                    {/* Grid tautan mengelompokkan resource teknologi dan kanal sosial agar mudah dipindai. */}
                ...
                {/* Garis pemisah memberi jeda visual sebelum teks copyright. */}
...
// Export default agar Footer dapat dipasang di halaman daftar dan detail post.
