// Komponen Footer yang memberikan informasi tentang situs, sumber daya, dan tautan media sosial. Ini adalah bagian penting dari tata letak situs web yang membantu pengguna menemukan informasi tambahan dan tetap terhubung dengan platform. 
// Footer ini dirancang dengan Tailwind CSS untuk memastikan responsivitas dan konsistensi gaya di seluruh situs. 
const Footer = () => {
    return (
...
// Ekspor komponen Footer agar dapat digunakan di bagian lain aplikasi, seperti di App.jsx untuk ditampilkan di seluruh halaman situs web.
