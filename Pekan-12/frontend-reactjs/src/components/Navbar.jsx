...
// Komponen Bar Navigasi (Header) Aplikasi.
const Navbar = () => {
    // Mengambil profil pengguna saat ini (`user`) dan fungsi `logout` dari context autentikasi.
    const { user, logout } = useAuth();
    // State lokal untuk melacak apakah menu seluler (mobile menu) sedang terbuka atau tertutup.
    const [mobileMenuOpen, setMobileMenuOpen] = useState(false);

    // Handler untuk memicu fungsi logout dari context autentikasi.
