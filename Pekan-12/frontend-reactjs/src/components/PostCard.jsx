...
// Komponen kartu ringkasan artikel.
const PostCard = ({ post }) => {
    // Fungsi untuk memotong teks artikel agar tidak terlalu panjang di halaman depan.
    ...
    // Fungsi utilitas untuk memformat jarak tanggal ke bentuk hari yang lalu (Time Ago).
    const formatDate = (dateString) => {
        if (!dateString) return '14 days ago';
        const date = new Date(dateString);
        const now = new Date();
        // Menghitung selisih waktu dalam milidetik dan mengonversinya ke satuan hari.
