// Komponen ProductList: menampilkan daftar produk dalam bentuk kartu.
export function ProductList(products, onAdd) {
    ...
    products.forEach((product) => {
        ...
        // Template HTML kartu produk berisi gambar, diskon, rating, fitur, harga, dan tombol add.
        card.innerHTML = `
        ...
        // Menghubungkan tombol Add dengan callback untuk memasukkan produk ke keranjang.
...
// Helper untuk menghasilkan SVG bintang rating.
function getStarSVG() {
