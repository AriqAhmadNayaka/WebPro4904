...
// Menampilkan informasi hak cipta, deskripsi platform singkat, dan tautan sumber daya.
const Footer = () => {
  return (
    <footer className="bg-white border-t border-gray-200">
      {/* Container utama dengan lebar maksimum terpusat agar terlihat premium */}
      <div className="max-w-screen-xl mx-auto px-4 py-8">
        <div className="md:flex md:justify-between">
          ...
          {/* Bagian Kanan: Tautan Navigasi Footer */}
