...
$route['api/auth/users'] = 'Api/Auth/users'; // [DEBUG] Melihat semua user terdaftar di database.
$route['api/auth/reset'] = 'Api/Auth/reset'; // [DEBUG] Menghapus semua data user untuk reset testing.
