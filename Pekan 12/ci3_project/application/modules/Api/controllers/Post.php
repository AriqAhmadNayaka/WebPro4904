...
class Post extends MX_Controller {
    ...
    public function index()
    {
        ...
        // Mengirim response sukses berisi semua post secara mentah (raw).
    ...
    public function show($id)
    {
        ...
        if (!$post) {
            ...
            echo json_encode(array('message' => 'Post tidak ditemukan.'));
            exit;
        }

        // Mengirim response sukses berisi detail post secara mentah (raw).
