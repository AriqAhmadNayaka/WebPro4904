...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $judulPost = trim($_POST['judul']);
    $kategoriPost = $_POST['kategori'];
    $deskripsiPost = trim($_POST['deskripsi']);
    $indexPost = $_POST['editIndex'];
        ...
        if (!empty($indexPost)) {
            ...
            if (!empty($namaFile)) {
                mysqli_query($conn, "
                    ...
                    SET judul='$judulPost', kategori='$kategoriPost', deskripsi='$deskripsiPost', file='$namaFile'
                    WHERE id=$indexPost
                ");
            } else {
                mysqli_query($conn, "
            ...
            mysqli_query($conn, "
                INSERT INTO informasi_medis (judul, kategori, deskripsi, file)
                VALUES ('$judulPost', '$kategoriPost', '$deskripsiPost', '$namaFile')
            ");
        }
    }
