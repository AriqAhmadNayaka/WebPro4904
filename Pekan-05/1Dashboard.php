...
// Jika session user_id tidak ada, cek cookie untuk melihat apakah pengguna memilih "Remember Me" saat login
// Jika cookie user_id dan nama ada, maka session akan dibuat berdasarkan cookie dan pengguna diarahkan ke dashboard
// Jika tidak ada keduanya, maka pengguna akan diarahkan ke halaman login
if (!isset($_SESSION['user_id'])) {
    ...
    if (isset($_COOKIE['user_id']) && isset($_COOKIE['nama'])) {
        ...
        // Jika tidak ada keduanya → balik ke login
...
<body class="background">
    <nav class="top-navbar">
        <div class="nav-left">
            <div class="logo">
                <span class="logo-text" <h3>Selamat datang di NaviBiz, <?php echo $_SESSION['nama']; ?></h3></span>
            </div>
        </div>
