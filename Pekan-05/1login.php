...
// Mengecek apakah session user_id sudah ada, jika sudah ada maka pengguna akan langsung diarahkan ke dashboard
// Jika session user_id tidak ada tetapi cookie user_id ada, maka session akan dibuat berdasarkan cookie dan pengguna diarahkan ke dashboard
session_start();
include "koneksi.php";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") { 
    ...
    // Variabel ini digunakan untuk menampilkan data login pengguna
     if ($usernameErr == "" && $passwordErr == "") {
        ...
        // Mempersiapkan statement SQL untuk memeriksa apakah username dan password yang dimasukkan cocok dengan data di database    
        ...
        // Mengecek apakah query menghasilkan setidaknya satu baris data yang cocok dengan username dan password yang dimasukkan
            ...
            // Mengecek apakah checkbox "Remember Me" dicentang oleh pengguna
            // Jika dicentang, maka cookie akan dibuat untuk menyimpan user_id dan nama selama 30 hari
