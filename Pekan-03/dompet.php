...
// maka data dikirim menggunakan metode GET
// Data yang dikirim melalui GET akan terlihat di URL
if(isset($_GET['tanggal'], $_GET['keterangan'], $_GET['jenis'], $_GET['jumlah'])){
  // Menambahkan data baru ke array $dataLaporan dengan nilai yang diambil dari form input
    $dataLaporan[] = [
    ...
    <section id="section-laporan-manual" style="margin-top: 24px; scroll-margin-top: 80px">
      ...
      <div class="row">
        <div class="form-card">
          ...
          <!-- Form input untuk menambahkan transaksi manual ke dalam laporan keuangan
          Form ini menggunakan metode GET, sehingga data yang diinput akan terlihat di URL setelah disubmit
          Form ini memiliki beberapa field input seperti tanggal, keterangan, jenis transaksi (pemasukan/pengeluaran), dan jumlah -->
        ...
        <div class="table-card" style="flex:1;">
          ...
          <tbody>
          <!-- Menampilkan seluruh data pemasukan dan pengeluaran
yang berasal dari array PHP $dataLaporan -->
          <?php 
          // // Melakukan perulangan untuk menampilkan semua data laporan
          foreach($dataLaporan as $row): ?>
          <tr>
          <!-- Menampilkan data tanggal, keterangan, jenis, dan jumlah dari setiap transaksi -->
          <td><?php echo htmlspecialchars($row['tanggal']); ?></td>
          <td><?php echo htmlspecialchars($row['keterangan']); ?></td>
          <td><?php echo htmlspecialchars($row['jenis']); ?></td>
          <td><?php echo htmlspecialchars($row['jumlah']); ?></td>
          </tr>
          <!-- Menutup perulangan setelah semua data laporan ditampilkan -->
          <?php endforeach; ?>
          </tbody>
          </table>
        </div>
