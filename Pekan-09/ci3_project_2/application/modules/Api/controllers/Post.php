...
class Post extends MX_Controller {
    ...
    public function update($id)
    {
        ...
        try {
            ...
            if (is_array($input['image']) && isset($input['image']['name']) && isset($input['image']['content'])) {
                $_FILES['image'] = [
            ...
            if ((!empty($_FILES['image']['name'])) || (isset($input['image']) && is_array($input['image']) && isset($input['image']['name']))) {
