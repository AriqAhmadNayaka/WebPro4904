...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url('assets/css/registrasi.css'); ?>">
</head>
<body>
    ...
    <script src="<?php echo base_url('assets/js/registrasi.js'); ?>"></script>
</body>
</html>
