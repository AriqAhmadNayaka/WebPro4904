...
<body>
    <div class="page">
        <div class="topbar">
            <a href="<?php echo site_url('dashboard'); ?>" class="brand">WeBandoo+</a>
            <div class="topbar-actions">
                <a href="<?php echo site_url('dashboard'); ?>" class="btn-link"><i class="fas fa-arrow-left"></i> Kembali ke Dashboard</a>
                <a href="<?php echo site_url('logout'); ?>" class="btn-link"><i class="fas fa-sign-out-alt"></i> Keluar</a>
            </div>
        </div>
        <div class="layout">
            <aside class="card profile-summary">
                <div class="profile-photo">
                    <img src="<?php echo base_url(htmlspecialchars($fotoProfil)); ?>" alt="Foto Profil" id="profileImagePreview">
                </div>
            ...
            <section class="card form-card">
                ...
                <form action="<?php echo site_url('proses-update-profil'); ?>" method="POST" enctype="multipart/form-data">
                ...
                <form action="<?php echo site_url('proses-update-profil'); ?>" method="POST" class="delete-form" onsubmit="return confirm('Yakin ingin menghapus seluruh data profil? Akun login tetap bisa digunakan.');">
