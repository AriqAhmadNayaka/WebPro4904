        ...
        <div class="form-group">
            ...
            <?php if ($post->image_url): ?>
                <div style="margin-bottom: 10px;">
                    ...
                    <img src="<?php echo $post->image_url; ?>" alt="Current image" style="max-width: 200px; border-radius: 8px;">
                </div>
            <?php endif; ?>
            ...
            <small style="display: block; margin-top: 5px; color: #666;">
                ...
                <?php if ($post->image_url): ?><br>Leave empty to keep current image<?php endif; ?>
            </small>
        </div>
