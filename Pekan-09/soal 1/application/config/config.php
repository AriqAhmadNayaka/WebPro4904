...
|
*/
// Base URL dibuat dinamis agar project tetap berjalan walaupun folder dipindah.
$config['base_url'] = (isset($_SERVER['HTTP_HOST']))
	? ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] !== 'off') ? 'https' : 'http').'://'.$_SERVER['HTTP_HOST'].str_replace(basename($_SERVER['SCRIPT_NAME']), '', $_SERVER['SCRIPT_NAME'])
	: '';

// Lokasi folder modules untuk struktur HMVC.
$config['modules_locations'] = array(
	APPPATH.'modules/' => '../modules/',
);

// Secret key untuk membuat dan memverifikasi token JWT.
$config['jwt_secret_key'] = 'ci3-hmvc-rest-api-secret';
...
|
*/
// index.php dikosongkan agar URL lebih bersih dengan bantuan .htaccess.
$config['index_page'] = '';
...
*/
// PATH_INFO lebih stabil untuk route CodeIgniter pada folder project yang memiliki spasi.
