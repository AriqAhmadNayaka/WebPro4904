...
<head>
    ...
    <title>Daftar Akun - SmartAir Quality</title>
...
<body>
    ...
    <div class="login-wrapper">
        ...
        <div class="form-box">
            <div class="top">
                ...
                <p>Bergabunglah dengan SmartTrash untuk mengelola kategori dan katalog barang daur ulang.</p>
            </div>
    ...
    <footer class="cyber-footer">
        ...
        <div class="footer-bottom">
            <p>&copy; 2026 SmartAir Quality Monitor .</p>
        </div>
    </footer>
</body>
</html>
