...
/**
 * 1. Flow Pengambilan Data
 * Mengambil seluruh data dokter dari database untuk ditampilkan di tabel.
 */
$doctorModel = new Doctor();
$dokter = $doctorModel->all();
?>
  ...
  <div class="admin-wrapper">
    ...
    <aside class="admin-sidebar acrylic-card">
      <div class="profile-sidebar">
        ...
        <h3 class="adminName"><?= $_SESSION["username"] ?></h3>
