...
// Perlindungan Halaman (Authentication Gate): 
// Mencegah orang mengakses dashboard dengan mengetik URL langsung jika belum login
if (!$userObj->checkSession()) {
    header("Location: 1login.php");
    exit();
}

// Mengambil nama pengguna dari session untuk ditampilkan di halaman dashboard
// Jika nama pengguna tidak tersedia di session, gunakan 'Pengguna' sebagai default untuk menghindari error undefined index
...
<body class="background">
    <nav class="top-navbar">
        <div class="nav-left">
            <div class="logo">
                <span class="logo-text" <h3>Selamat datang di NaviBiz, <?php echo htmlspecialchars($username); ?></h3></span>
            </div>
        </div>
