...
$session = new Session(); // untuk membuat object

$session->checkCookie();  // cek cookie dulu
$session->checkLogin();   // cek login

$username = $session->getUser(); // untuk mengambil username
?>
        ...
        <div class="nav-right">
            ...
            <div class="profile-dropdown">
                ...
                <div class="dropdown-menu">
                    ...
                    <hr>
                    <a href="login.php" class="dropdown-item logout">Logout</a>
                </div>
            </div>
        </div>
    </nav>
