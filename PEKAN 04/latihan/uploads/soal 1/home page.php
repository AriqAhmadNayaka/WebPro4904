...
<body>
    ...
    <nav class="navbar">
        <a href="home page.php" class="logo">WeBandoo+</a>
        <ul class="nav-links">
            <li><a href="home page.php" class="nav-link active"><i class="fas fa-chart-line"></i> Dashboard</a></li>
        ...
        <div class="navbar-right">
            ...
            <a href="keluar.php" name="keluar" lass="toggle-btn-set"><i class="fas fa-sign-out-alt"></i> Keluar</a>
        </div>
    </nav>
