...
<header class="site-header">
    <div class="container nav-wrap">
        <div>
            <p class="eyebrow">Smart City Kota Jambi</p>
            <h1 class="brand-title">SmartTrash Monitoring</h1>
        </div>
        <nav class="nav-links">
            <?php if (is_logged_in()): ?>
                <a href="dashboard.php">Dashboard</a>
                <a href="pemantauan.php">Data Laporan</a>
                <a href="tambah_pemantauan.php">Tambah Pemantauan</a>
