        ...
        if (!in_array($ekstensiFile, $ekstensiValid)) {
            ...
            if (move_uploaded_file($tmpName, 'img/' . $namaFileBaru)) {
                ...
                if ($role === "admin") {
                    ...
                    $cek = mysqli_query(
                        $conn,
                        "SELECT email FROM datauser WHERE email='$email'"
                    );
                    ...
                    if (mysqli_num_rows($cek) > 0) {
                        ...
                        $sql = "INSERT INTO datauser
                                (name,email,password,role,gambar)
                                VALUES
                                ('$nama','$email','$passwordHash','user','$namaFileBaru')";
                ...
                $error = "Folder img tidak ditemukan!";
            }
        }
    }
}
...
$result = mysqli_query(
    $conn,
    "SELECT * FROM datauser ORDER BY id DESC"
);
?>
...
<body>
    ...
    <header class="main-header">
        <div style="font-size: 20px; font-weight: bold; color: #00d4ff;">SmartTrash</div>
    ...
    <footer class="cyber-footer">
        <div class="footer-content">
            <div class="footer-section">
                <h3 style="color: #00d4ff; margin: 0;">SmartTrash</h3>
                <p style="max-width: 300px;">Platform Tempat Sampah Cerdas Anda.</p>
            </div>
            <div class="footer-section">
                <h4>Contact Us</h4>
                <p>Bandung, Indonesia<br>support@SmartTrash</p>
            </div>
            <div class="footer-section">
                <h4>Follow Us</h4>
        ...
        <div style="text-align: center; margin-top: 20px; font-size: 11px; color: #444;">
            &copy; 2026 SmartTrash Project. All Rights Reserved.
        </div>
    </footer>
