...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST["daftar"])) {
    ...
    if ($nama === "" || $email === "" || $password === "" || $confirmPassword === "") {
        ...
        if ($auth->register($nama, $email, $password)) {
            ...
            $error = "Email sudah terdaftar atau sistem error!";
        }
    }
}
?>
...
<div class="login-wrapper">
    ...
    <div class="image-box">
        <img src="cybersecurity_NicoElNino-AlamyStockPhoto.jpg"
             alt="Cyber Security Registration">
    </div>
    ...
    <div class="form-box">
        ...
        <div class="top">
            ...
            <p>
                Bergabunglah dengan CyberVault
                untuk pengalaman keamanan digital yang lebih baik.
            </p>
    ...
    <div class="footer-container">
        ...
        <div class="footer-section">
            ...
            <p>
                ...
                melalui edukasi keamanan siber modern.
            </p>
        </div>
