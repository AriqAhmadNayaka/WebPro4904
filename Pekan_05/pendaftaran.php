...
if (isset($_POST["username"])) {
    ...
    $sql = "INSERT INTO users (nama, email, password, username, telepon, alamat) VALUES (?, ?, ?, ?, ?, ?)";
    ...
    $stmt->bind_param("ssssss", $nama, $email, $password, $username, $telepon, $alamat);
...
<body>
    ...
    <div class="form-container">
        <form class="form-box" method="post" action="dompet.php">
