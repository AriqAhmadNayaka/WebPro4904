...
//keputusan untuk menampilkan data anak pertama di dashboard
$error = '';
$success = '';
...
//proses simpan data anak (tambah atau edit)
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['simpan'])) {
    ...
    if ($formData['nama'] === '' || $formData['gender'] === '' || $formData['tanggal_lahir'] === '' || $formData['kelas'] === '') {
        ...
        try {
            ...
            //kembali ke halaman index dengan status sukses
...
//menampilkan pesan sukses berdasarkan status yang dikirim melalui query string
...
//jika editId > 0 dan bukan request POST, berarti user baru masuk ke halaman ini untuk edit data anak, maka ambil data anak yang akan diedit
                ...
                <div class="child-list">
                    <?php foreach ($children as $child): ?>
                        <div class="child-item">
                            ...
                            //tombol edit dan hapus data anak
