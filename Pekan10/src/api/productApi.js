// Ini pura-puranya API produk, jadi datanya dibuat manual tapi cara ambilnya tetap async.
export const fetchProducts = async () => {
return new Promise((resolve) => {

// setTimeout dipakai biar rasanya kayak nunggu data dari server beneran.
setTimeout(() => {
resolve([
{
id: 1,
