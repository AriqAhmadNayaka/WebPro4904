<?php
// CI3: $username sudah dikirim dari controller Dashboard->index()
// Tidak perlu lagi session_start() atau include Session.php — CI3 handle otomatis
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="nav-right">
            ...
            <div class="profile-dropdown">
                <button class="nav-icon profile-icon" aria-label="Profil">
                    <img src="<?php echo base_url('assets/profil.jpeg'); ?>" alt="Profil" class="avatar">
                </button>
                <div class="dropdown-menu">
                    <div class="profile-info">
                        <img src="<?php echo base_url('assets/profil.jpeg'); ?>" alt="Aila" class="avatar-lg">
                        <div>
                            <p class="name"><?php echo htmlspecialchars($username); ?></p>
                            <p class="email"><?php echo htmlspecialchars($username); ?>@navibiz.com</p>
                        </div>
                    </div>
                    <a href="profile.html" class="dropdown-item">Profil</a>
                    <a href="settings.html" class="dropdown-item">Pengaturan</a>
                    <hr>
                    <!-- CI3: logout melalui controller Auth method logout -->
                    <a href="<?php echo base_url('auth/logout'); ?>" class="dropdown-item logout">Logout</a>
                </div>
            </div>
        </div>
    </nav>
            ...
            <div class="side-icons">
                <a href="petaumkm.html">
                    <button class="icon-pill" aria-label="Peta UMKM">
                        <img class="icon-image" src="<?php echo base_url('assets/lokasi_icon-removebg-preview.png'); ?>" alt="">
                    </button>
                </a>
                <a href="kategori.html">
                    <button class="icon-pill" aria-label="Jenis UMKM">
                        <img class="icon-image" src="<?php echo base_url('assets/shop_icon-removebg-preview.png'); ?>" alt="">
                    </button>
                </a>
                <a href="delivery.html">
                    <button class="icon-pill" aria-label="Delivery">
                        <img class="icon-image" src="<?php echo base_url('assets/fast-delivery_icon-removebg-preview.png'); ?>" alt="">
                    </button>
                </a>
                <a href="pesan.html">
                    <button class="icon-pill" aria-label="Pesan">
                        <img class="icon-image" src="<?php echo base_url('assets/chat_icon-removebg-preview.png'); ?>" alt="">
                    </button>
                </a>
                <a href="pembukaan-investasi.html">
                    <button class="icon-pill" aria-label="Investasi">
                        <img class="icon-image" src="<?php echo base_url('assets/invest_icon-removebg-preview.png'); ?>" alt="">
                    </button>
                </a>
            </div>
            ...
            <div class="side-bottom">
                <a href="pengaturan.html">
                    <button class="icon-pill" aria-label="Pengaturan">
                        <img class="icon-image" src="<?php echo base_url('assets/pengaturan_icon-removebg-preview.png'); ?>" alt="">
                    </button>
                </a>
                <!-- CI3: logout melalui controller -->
                <a href="<?php echo base_url('auth/logout'); ?>">
                    <button class="icon-pill" aria-label="Logout">
                        <img class="icon-image" src="<?php echo base_url('assets/keluar_icon-removebg-preview.png'); ?>" alt="">
                    </button>
                </a>
            </div>
        </div>
    ...
    <div class="slider" id="Dashboard">
        ...
        <div class="slide active">
            <div class="pamflet-card">
                <img src="<?php echo base_url('assets/3.png'); ?>" alt="Pamflet 1">
        ...
        <div class="slide">
            <div class="pamflet-card">
                <img src="<?php echo base_url('assets/2.png'); ?>" alt="Pamflet 2">
                <div class="pamflet-info">
        ...
        <div class="slide">
            <div class="pamflet-card">
                <img src="<?php echo base_url('assets/1.png'); ?>" alt="Pamflet 3">
                <div class="pamflet-info">
    ...
    <div class="login-options">
        <div class="login-row">
            <a href="petaumkm.html" style="text-decoration: none;">
                <div class="login-option">
                    <video class="circle-video" autoplay loop muted playsinline>
                        <source src="<?php echo base_url('assets/peta.mp4'); ?>" type="video/mp4">
                    </video>
            ...
            <a href="investasi.html" style="text-decoration: none;">
                <div class="login-option">
                    <video class="circle-video" autoplay loop muted playsinline>
                        <source src="<?php echo base_url('assets/investasi saham.mp4'); ?>" type="video/mp4">
                    </video>
            ...
            <a href="kategori.html" style="text-decoration: none;">
                <div class="login-option">
                    <video class="circle-video" autoplay loop muted playsinline>
                        <source src="<?php echo base_url('assets/umkm.mp4'); ?>" type="video/mp4">
                    </video>
            ...
            <div class="login-row">
                <a href="delivery.html" style="text-decoration: none;">
                    <div class="login-option">
                        <video class="circle-video" autoplay loop muted playsinline>
                            <source src="<?php echo base_url('assets/delivery.mp4'); ?>" type="video/mp4">
                        </video>
                        <label>Delivery</label>
                    </div>
                </a>

                <!-- CI3: link ke Dompet controller -->
                <a href="<?php echo base_url('dompet'); ?>" style="text-decoration: none;">
                    <div class="login-option">
                        <video class="circle-video" autoplay loop muted playsinline>
                            <source src="<?php echo base_url('assets/dompet.mp4'); ?>" type="video/mp4">
                        </video>
                ...
                <a href="pesan.html" style="text-decoration: none;">
                    <div class="login-option">
                        <video class="circle-video" autoplay loop muted playsinline>
                            <source src="<?php echo base_url('assets/pesan.mp4'); ?>" type="video/mp4">
                        </video>
                        <label>Pesan</label>
                    </div>
                </a>
            ...
            <div class="chat-section">
                <div class="chat-option">
                    <video class="kotak-option" autoplay loop muted playsinline>
                        <source src="<?php echo base_url('assets/ai asisten.mp4'); ?>" type="video/mp4">
                    </video>
        ...
        <a href="komunitas.html" style="text-decoration: none;">
            <div class="chat-option">
                <video class="kotak-option" autoplay loop muted playsinline>
                    <source src="<?php echo base_url('assets/komunitas.mp4'); ?>" type="video/mp4">
                </video>
